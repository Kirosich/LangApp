...
export const api = {
  ...
  getGamificationSummary: (language) => apiFetch(withQuery('/api/gamification/summary', { language })),
  ...
  getBadges: (language) => apiFetch(withQuery('/api/gamification/badges', { language })),
  ...
  getProblemCards: (language) => apiFetch(withQuery('/api/gamification/problem-cards', { language })),
  ...
  getParadigmTypes: (language) => apiFetch(withQuery('/api/theory/paradigms/types', { language })),
  getRandomParadigm: (language, type) => apiFetch(withQuery('/api/theory/paradigms/random', { language, type })),
  ...
  getQuests: (language) => apiFetch(withQuery('/api/quests', { language })),
